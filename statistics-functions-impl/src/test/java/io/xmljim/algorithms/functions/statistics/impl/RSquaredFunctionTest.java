...
public class RSquaredFunctionTest {
    ...
    void compute() throws IOException {
        ...
        ScalarFunction intercept = functionProvider.getFactory().intercept(meanX, meanY, slope);
        ScalarFunction residualVariance = functionProvider.getFactory().residualSumOfSquares(yearVector, logAdjustedNetGainVector, slope, intercept);
        ScalarFunction totalVariance = functionProvider.getFactory().totalSumOfSquares(logAdjustedNetGainVector, meanY);
        ScalarFunction rSquaredFunction = functionProvider.getFactory().rSquared(residualVariance, totalVariance);
