...
public class StatisticsProviderImpl implements StatisticsProvider {
    private StatisticsFunctions statisticsFunctions = new StatisticsFunctionsImpl();
    @Override
    public StatisticsFunctions getFactory() {
        return statisticsFunctions;
    }

    @Override
    public Version getProviderVersion() {
        try (InputStream inputStream = getClass().getResourceAsStream("/statistics-impl-build.properties")) {
