package io.xmljim.algorithms.service.stocks.client;
...
public class CPIClient {
    ...
    @Value("${services.dependencies.cpi.endpoints.inflationMultiplier.method}")
    public String INFLATION_METHOD;

    @Value("${services.dependencies.cpi.endpoints.inflationMultiplier.path}")
    public String INFLATION_PATH;

    @Value("${services.dependencies.cpi.endpoints.averageInflation.method}")
    public String AVG_INFLATION_METHOD;
